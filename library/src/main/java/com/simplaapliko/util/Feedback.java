...
public final class Feedback {
    ...
    public static void sendFeedback(Context context, String email, String appName) {
        ...
        body.append(context.getString(R.string.feedback_device));
        body.append(Build.MANUFACTURER);
        body.append(" ");
        body.append(Build.MODEL);
        body.append(newLine);
        body.append(context.getString(R.string.feedback_android_version));
        body.append(Build.VERSION.RELEASE);
        body.append(newLine);
        body.append(context.getString(R.string.feedback_region));
        ...
        body.append(context.getString(R.string.feedback_app_version));
        ...
        body.append(context.getString(R.string.feedback_screen));
        body.append(context.getString(R.string.feedback_screen_width));
        body.append(Integer.toString(width));
        body.append(" ");
        body.append(context.getString(R.string.feedback_screen_height));
        body.append(Integer.toString(height));
        body.append(" ");
        body.append(context.getString(R.string.feedback_screen_density_dpi));
        body.append(Float.toString(dm.densityDpi/160));
        body.append(newLine);
        body.append(newLine);
        body.append(context.getString(R.string.feedback_message));
        body.append(newLine);
        body.append(newLine);

        String subject = "[" + appName + "] " + context.getString(R.string.feedback_subject);
